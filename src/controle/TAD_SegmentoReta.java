...
public class TAD_SegmentoReta implements TAD_Conjuntos {

	public TAD_SegmentoReta() {
		// TODO Auto-generated constructor stub
	}

	@Override
	public boolean memberS(SubConjunto subconjunto, Object elemento) {
		SegmentoDeReta u = (SegmentoDeReta) elemento;
		...
		if (a.hash_subconjunto == b.hash_subconjunto) {
			...
			if (a.ordenado) {
				...
				while (iterator_aux.hasNext()) {
					SegmentoDeReta aux = (SegmentoDeReta) iterator_aux.next();
					this.insertS(k, aux);
				}
			...
			while (iterator.hasNext()) {
				...
				SegmentoDeReta aux = (SegmentoDeReta) iterator.next();
				if (k.ordenado) {
	...
	public Ponto distanciaReta(Ponto a, Ponto b) {
