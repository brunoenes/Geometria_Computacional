...
public class GuiPontoProximoSegmentoReta extends javax.swing.JFrame {

	/** Creates new form MainFrame */
	public GuiPontoProximoSegmentoReta() {
		setResizable(false);
	...
	private void initComponents() {
		...
		jPanel1 = new javax.swing.JPanel() {
			...
			public void paintComponent(Graphics g) {
				...
				if(resultado) {
					...
					g.fillOval((int) pontoResultado.getX(), (int) pontoResultado.getY(), 5, 5);
					g.drawLine((int) p3.getX(), (int) p3.getY(), (int) pontoResultado.getX(), (int) pontoResultado.getY());
				}
		...
		setTitle("Ponto Mais Proximo de um Segmento de Reta");
		...
		btnCalcularDistancia.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {				
				reta = new Reta(p1,p2);
				pontoResultado = classicos.pontoMaisProximoSegmentoReta(p3, reta);
				resultado = true;
				...
				String texto = "Reta [\nPonto 1: (" + reta.p1.x +"," + reta.p1.y + ")" +				
						       ...
						       "\n\n Ponto 3: (" + p3.x +"," + p3.y + ")" +
						       "\n\n Ponto mais proximo: (" + pontoResultado.x + "," + pontoResultado.y + ")";
	...
	private int state;
	private JButton btnCalcularDistancia = new JButton("Calcular Ponto");
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(GuiPontoProximoSegmentoReta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				GuiPontoProximoSegmentoReta distancia = new GuiPontoProximoSegmentoReta();
