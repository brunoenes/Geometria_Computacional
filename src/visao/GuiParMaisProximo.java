...
public class GuiParMaisProximo extends JFrame {

	private static final long serialVersionUID = -2955047823251180820L;

	public GuiParMaisProximo() {
		initComponents();
	...
	private void initComponents() {
		...
		jButton1.setText("Divisção e Conquista");
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(GuiParMaisProximo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				new GuiParMaisProximo().setVisible(true);
			}
		});
	}
